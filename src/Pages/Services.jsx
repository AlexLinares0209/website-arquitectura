...
const Services = () => {
  return (
    <div className="services">
        <h2 className="animate__animated animate__slideInDown">Mis Servicios</h2>
        <p className="animate__animated animate__slideInLeft">Ofrezco una gama completa de servicios de arquitectura para satisfacer las necesidades de mis clientes, desde el diseño conceptual 
        ...
        <div className="contact-container animate__animated animate__slideInRight">
